...
| gegevensdefinitie | De beschrijving van de betekenis van een modelelement in een gegevensmodel. | Dit metagegeven komt overeen met het metagegeven 'Definitie' uit MIM-1.2. zoals toegepast bij een LGM. Dit is vooral nodig voor gegevenstype en gegevensobjecttype, maar kan ook bij andere modelelementen worden toegepast. | 
